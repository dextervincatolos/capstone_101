    ...
    <aside class="main-sidebar sidebar-light-primary elevation-4">
        ...
        <nav class="mt-2">
            ...
            <li class="nav-item menu-open">
                ...
                <li class="nav-item">
                    <a href="faculty_tbl.php" class="nav-link active">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Faculty Table</p>
                    </a>
                </li>
                                ...
                                if(mysqli_num_rows($res) > 0)
                                {
                                    while($row = mysqli_fetch_assoc($res))
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td> <?php echo $row['facultyContact']?> </td>
                                            <td> <?php echo $row['facultyEmail']; ?> </td>
                                            <td> <?php echo $row['facultyAddress']; ?> </td>
                                            <td> <?php echo $row['facultyStatus']; ?> </td>
                                            <td> <?php echo $row['facultyRole']; ?> </td>
                                            <td> <?php echo $row['assignedDepartment']; ?> </td>
