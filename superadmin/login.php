...
<head>
  ...
  <title>CICS | Admin login</title>
  
  <link href="../assets/img/cics-logo.png" rel="icon">
      ...
      <form action="loginRequest.php" method="POST">
        ...
        <div class="row">
          <div class="col-12 mb-2">
            <button type="submit" class="btn btn-primary btn-block" name="login" id="userLoginBtn">LOGIN</button>
          </div>
        </div>
